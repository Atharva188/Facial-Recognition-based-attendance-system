...
class Student:
    def __init__(self,root):
        ...
        img_logo = Image.open("college_images/clg_logo.jpg")
        ...
        img30 = Image.open("college_images/information.png")
        img30 = img30.resize((550,80), Image.ANTIALIAS)
        ...
        img20 = Image.open("college_images/clg_logo.jpg")
        img20 = img20.resize((500,200), Image.ANTIALIAS)
        ...
        comSemester=ttk.Combobox(std_Info_label_frame,textvariable=self.var_semester,state="readonly",
                                                        font=("arial",12,"bold"),width=17)
        comSemester['value']=("Select Semester","Odd","Even")
