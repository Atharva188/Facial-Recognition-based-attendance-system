...
class Developer:
    def __init__(self,root):
        ...
        title=Label(self.root,text="DEVELOPERS INFORMATION",font=("times new roman",35,"bold"),bg="white",fg="blue")
        ...
        img11 = Image.open(r"college_images\background.jpg")
        ...
        support=Label(Manage_std_frame1,bg="black",fg="blue",text="TEAM MEMBERS:",font=("times new roman",16,"bold"))
        support.place(x=10,y=5)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="ATHARVA GANPAT",font=("arial",12,"bold"))
        support.place(x=10,y=55)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="ABHISHEK JOSHI",font=("arial",12,"bold"))
        support.place(x=10,y=85)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="HARSHAL ADHAV",font=("arial",12,"bold"))
        support.place(x=10,y=115)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="AMOGH DAHITULE",font=("arial",12,"bold"))
        support.place(x=10,y=145)

        support=Label(Manage_std_frame1,bg="black",fg="blue",text="GUIDE:",font=("times new roman",16,"bold"))
        support.place(x=280,y=5)


        support=Label(Manage_std_frame1,bg="black",fg="white",text="PROF. SANDEEP THORAT",font=("arial",12,"bold"))
        support.place(x=280,y=55)
