...
class Login_Window:
    def __init__(self,root):
        ...
        title=Label(bg_lbl,text="MIT-ADT ATTENDANCE MONITORING SYSTEM",font=("times new roman",25,"bold"),bg="white",fg="black")
        ...
        # myname=Label(self.root,text="Developed By:Atharva",fg="black",bg="white",font=("times new roman",18,"bold"))
        ...
        img1=Image.open("college_images/mit_logo.jpeg")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost" , user="root",password="Atharva@18#",database="facial_recognition" ,  auth_plugin='mysql_native_password')
...
class Register:
    def __init__(self,root):
        ...
        # ============left image==================
        self.bg1=ImageTk.PhotoImage(file="college_images/dome.jpg")
        ...
        self.combo_securiy_Q["values"]=("Select","Your Birth Place?","Your Favorite Book Name?","Your Pet Name?")
