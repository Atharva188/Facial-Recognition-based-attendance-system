...
class Recognition_Face:
    def __init__(self,root):
        ...
        img_logo = Image.open("college_images/faceRecog1.jpeg")
        ...
        bg_lbl.place(x=40,y=40,width=1530,height=700)

        b3 =Button(bg_lbl,text="Face Recognition",command=self.detect_face,borderwidth=6,font=("times new roman",18,"bold"),bg="darkblue",activebackground="red",fg="white",cursor="hand2")
        b3.place(x=650,y=30,width=200,height=40)
