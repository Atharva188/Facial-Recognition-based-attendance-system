...
class ChatBot: 
    ...
    def send(self):
        ...
        elif (self.e.get().casefold()=="How are you"):
            self.text.insert(END,"\n\n"+"Bot: Fine and you")

        elif (self.e.get()=="Who is HOD"):
            self.text.insert(END,"\n\n"+"Bot: Dr.Prof.Sudarsan Sanap HOD of Mechanical Department will be available on\n the second floor of engineering building")

        elif (self.e.get()=="Who created you"):
            self.text.insert(END,"\n\n"+"Bot: Final Year Students Atharva Ganpat, Abhishek Joshi, Amogh Dahitule and \nHarshal Adhav created the Chat-Bot under the guidance of Prof.Sandeep Thorat")
        ...
        elif (self.e.get()=="Where is admission cell"):
            self.text.insert(END,"\n\n"+"Bot: Admission cell and the office is at the third floor of Engineering building.")
