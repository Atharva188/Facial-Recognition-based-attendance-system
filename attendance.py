...
class Attendace:
    def __init__(self,root):
        ...
        img10 = Image.open("college_images/background.jpg")
        img10 = img10.resize((800,200), Image.ANTIALIAS)
        self.photoImg10 = ImageTk.PhotoImage(img10)
        bg_lbl=Label(self.root,image=self.photoImg10)
        bg_lbl.place(x=0,y=0,width=800,height=200)

        img11 = Image.open("college_images/background.jpg")
        ...
        img30 = Image.open("college_images/attendance1.jpg")
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Atharva@18#",database="facial_recognition",  auth_plugin='mysql_native_password')
