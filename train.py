...
class Train_Data:
    def __init__(self,root):
        ...
        # ==================Train label Button ===========================================
        title=Label(self.root,text="Photo Sample Training",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        bg_lbl.place(x=0,y=55,width=1530,height=900)
        ...
        b3 =Button(self.root,text="TRAIN DATA",command=self.train_classifier,borderwidth=15,font=("times new roman",25,"bold"),bg="darkblue",activebackground="darkblue",fg="white",cursor="hand2")
        b3.place(x=250,y=150,width=1000,height=75)
