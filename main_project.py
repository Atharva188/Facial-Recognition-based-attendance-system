...
class FaceRecognitionSystem:
    def __init__(self,root):
        ...
        # ====================Background image==============================================
        img1 = Image.open("college_images/background.jpg")
        ...
        # ==================== Project title ==================================================
        title=Label(bg_lbl,text="MIT-ADT ATTENDANCE MONITORING SYSTEM",font=("times new roman",30,"bold"),bg="white",fg="black")
        ...
        lbl = Label(title, font = ('times new roman',14, 'bold'),background = 'white',foreground = 'black')
        lbl.place(x=0,y=(-15),width=110,height=50) 
        time() 

        # myname=Label(self.root,text="Developed By:Atharva",fg="white",bg="black",font=("times new roman",18,"bold"))
        # myname.place(x=0,y=0)

        # ==================Employee Department Button ===========================================
        
        img2 = Image.open("college_images/sstudent.png")
        ...
        b3 =Button(self.root,text="STUDENT DETAILS",borderwidth=5,font="comicsansns 15 bold",bg="darkblue",fg="white",cursor="hand2")
        ...
        # ==================Train Button ===========================================
        img3 = Image.open("college_images/trainData.jpg")
        ...
        img = Image.open("college_images/faceRecog.jpg")
        ...
        # ==================Sample Image Button ===========================================
        img4 = Image.open("college_images/photoSample.jpg")
        ...
        img5 = Image.open("college_images/attendance.jpg")
        ...
        img7 = Image.open("college_images/developers.jpg")
        ...
        # ==================Exit Image Button ===========================================
        img8 = Image.open("college_images/exit1.jpg")
